...
public class CustomerPositionTransaction2Denormalized extends CustomerPositionTransaction2 {
	...
	public void invokeCustomerPositionFrame1() {
		...
		String getCustomerAccountInfo = "SELECT TOP 10 [tpcE].[dbo].[DTT2T3T8F2].DT_CA_ID AS CA_ID, DT_CA_BAL AS CA_BAL, (sum(DT_HS_QTY * DT_LT_PRICE)) as RES_SUM\r\n" + 
				"\r\n" + 
				"FROM [tpcE].[dbo].[DTT2T3T8F2] inner join [tpcE].[dbo].[DTT8F6] ON [tpcE].[dbo].[DTT2T3T8F2].[DT_CA_ID] = [tpcE].[dbo].[DTT8F6].[DT_CA_ID]\r\n" + 
				" \r\n" + 
				"WHERE DT_CA_C_ID = ? and DT_HS_S_SYMB IS NOT NULL\r\n" + 
				"\r\n" + 
				"group by [tpcE].[dbo].[DTT2T3T8F2].DT_CA_ID, DT_CA_BAL\r\n" + 
				"\r\n" + 
				"order by 3 asc;";
