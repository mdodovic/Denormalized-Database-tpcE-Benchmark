...
public class NormalizedChemaCreator {
	...
	private static String createConstraintsTableQuerry(String tableName) {

		switch(tableName) {
			case "HOLDING": return 
					"ALTER TABLE [tpcE].[dbo].[HOLDING] ADD CONSTRAINT FK_HOLDING_H_T_ID_TRADE_T_ID FOREIGN KEY (H_T_ID) REFERENCES TRADE(T_ID);\r\n" + 
					"ALTER TABLE [tpcE].[dbo].[HOLDING] ADD CONSTRAINT FK_HOLDING_H_CA_ID_H_S_SYMB_HOLDING_SUMMARY_HS_CA_ID_HS_S_SYMB FOREIGN KEY (H_CA_ID,H_S_SYMB) REFERENCES HOLDING_SUMMARY(HS_CA_ID,HS_S_SYMB);\r\n" ;			
			...
			case "ACCOUNT_PERMISSION": return 
			...
			case "COMPANY_COMPETITOR": return 
